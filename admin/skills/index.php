      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <button id="btnDelSkills" class="del btn btn-primary hidden" type="submit"><i class="fa fa-trash"></i>Trash</button>
            ...
            <div class="table-responsive">
              ...
              <div>
                <label style="float:right">Search:
                  <input id="searchSkills" type="text" class="form-control">
                </label>
              ...
              <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody id="data">
                <?php
                  $sql = "select id, name, percent from skills where user_id = {$_SESSION['userLogin']['id']}";
